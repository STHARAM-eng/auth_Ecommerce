...
const EmailVerify = () => {
  return (
    <>
      ...
      <form className=" flex flex-col items-center gap-2 mt-5 max-w-sm mx-auto">
        ...
        <div className="block mt-6 mb-4">
          <Button
            type="submit"
            className=" text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-2xl text-base  py-2.5 text-center "
          >
            Verify Email
          </Button>
        </div>
